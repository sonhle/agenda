...
var debug = require('debug')('agenda:internal:_findAndLockNextJob');
...
module.exports = function (jobName, definition, cb) {
  ...
  debug('_findAndLockNextJob(%s, [Function], cb)', jobName); // Don't try and access MongoDB if we've lost connection to it.
